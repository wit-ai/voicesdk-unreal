...
updateFileAsync('all-in-one\\VoiceSDK.uplugin', VERSION_KEY_STRING_START,process.argv[2] , VERSION_KEY_STRING_END, ()=>{
  updateFileAsync('all-in-one\\VoiceSDK.uplugin', VERSION_NAME_KEY_STRING_START,process.argv[3] , VERSION_NAME_KEY_STRING_END);
});
